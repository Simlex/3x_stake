...
<html dir="ltr" xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" lang="en" style="font-family:arial, 'helvetica neue', helvetica, sans-serif">
 <head>
  ...
  <title>Verify your Yieldra account</title><!--[if (mso 16)]>
    <style type="text/css">
               ...
               <table cellpadding="0" cellspacing="0" width="100%" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                 <tr>
                  <td align="center" valign="top" style="padding:0;Margin:0;width:520px">
                   <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;border-radius:20px" role="presentation">
                     <tr>
                      <td align="center" style="Margin:0;padding-bottom:10px;padding-left:20px;padding-right:20px;padding-top:30px">
                        <h1 style="Margin:0;line-height:48px;mso-line-height-rule:exactly;font-family:'Josefin Sans', helvetica, arial, sans-serif;font-size:40px;font-style:normal;font-weight:normal;color:#111">
                            Verify Your Account
                    </h1>
                    </td>
                     </tr>
               ...
               <table cellpadding="0" cellspacing="0" width="100%" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                 <tr>
                  <td align="center" valign="top" style="padding:0;Margin:0;width:520px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="left" style="padding:0;Margin:0;padding-top:5px;padding-bottom:0px">
                        <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'Josefin Sans', helvetica, arial, sans-serif;line-height:21px;color:#4b5563;font-size:14px">
                            Hi there, <br><br>
                            Welcome to Yieldra! We're excited to have you join our community of crypto stakers. To complete your registration and start earning rewards, we need to verify your email address: <a href="mailto:{{userEmail}}" style="color: #9333ea;">{{userEmail}}</a>. 
                            <br><br>
                            The code below is your verification code. This code is only valid for 10mins for security purpose.
                            <br><br><br>
                        </p>
                    </td>
                     </tr>
...
<![endif]--><!--[if !mso]><!-- -->
<span class="msohide es-button-border" style="font-size: 28px; font-weight: 700; display:inline-block;border-radius:30px;width:auto;mso-hide:all">
    {{code}}
</span>
<!--<![endif]-->
</td>
...
<tr>
                      <td align="left" style="padding:0;Margin:0;padding-top:30px">
                        <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'Josefin Sans', helvetica, arial, sans-serif;line-height:21px;color:#4b5563;font-size:14px">
                            If you didn't request this email, you can safely ignore it. For any questions, contact our support team.
                            <br><br>
                        </p>
                    </td>
                     </tr>
        ...
        <tr>
         <td align="center" style="padding:0;Margin:0">
          <table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0" cellspacing="0" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:600px">
            <tr>
             <td align="left" bgcolor="#222222" style="Margin:0;padding-left:20px;padding-right:20px;padding-top:2px;padding-bottom:2px;background-color:#f43f5e">
            </td>
            </tr>
          </table></td>
        </tr>
