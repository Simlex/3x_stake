                     ...
                     <tr>
                      <td align="left" style="padding:0;Margin:0;padding-top:5px;padding-bottom:5px">
                        <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'Josefin Sans', helvetica, arial, sans-serif;line-height:21px;color:#4b5563;font-size:14px">
                            Hi {{username}}, <br><br>
                            We received a request to reset your password. If you didn't make the request, just ignore this email. Otherwise, click the button below to reset your password. 
                        </p>
                    </td>
                     </tr>
                     <tr>
...
<tr>
    <td align="left" style="padding:0;Margin:0;padding-top:15px;padding-bottom:5px">
      <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'Josefin Sans', helvetica, arial, sans-serif;line-height:21px;color:#38363A;font-size:14px">
          ...
          <a href="{{resetLink}}" style="color:#8133f1">{{resetLink}}</a>
          <br>
      </p>
    </td>
   </tr>
   <tr>
    <td align="left" style="padding:20px 0;Margin:0;">
      <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'Josefin Sans', helvetica, arial, sans-serif;line-height:21px;color:#38363A;font-size:14px">
          This code will expire in <b>10 minutes</b>. Please do not share this link with anyone.
          <br>
      </p>
    </td>
   </tr>
