...
interface AdminDepositDetailsModalProps {
  deposit: UserStakingPosition;
  isOpen: boolean;
  onClose: () => void;
  onApprove: () => void;
}

export function AdminDepositDetailsModal({
  deposit,
  isOpen,
  onClose,
  onApprove
}: AdminDepositDetailsModalProps) {
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-2">
                <h2 className="text-xl font-bold">
                  Deposit #{deposit.id.substring(0, 8)}
                </h2>
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    ...
                    <div className="w-[70%] flex items-center">
                      <span className="font-mono w-full text-sm truncate">
                        {deposit.id}
                      </span>
                      <Button
                        variant="ghost"
                        size="sm"
                        className="ml-2"
                        onClick={() => handleCopyItem(deposit.id)}
                  ...
                  <div className="flex justify-between">
                    ...
                    <span>{getStatusBadge(deposit.depositStatus)}</span>
                  </div>
                </div>
              </div>
