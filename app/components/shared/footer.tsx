        ...
        {/* <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 text-sm mb-4">
              The most secure and flexible staking platform for USDT, offering competitive APR rates and instant
              rewards.
            </p>
...
function SocialLink({ href, icon }: { href: string; icon: React.ReactNode }) {
  return (
    ...
    >
      <span className="text-gray-400 hover:text-white transition-colors duration-200">{icon}</span>
    </Link>
  )
}
