...
export default function ForgotPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await profileApi.forgotPassword(email);
      console.log("🚀 ~ handleSubmit ~ response:", response);
      setError("");

      // For security reasons, we always show success even if the email doesn't exist
      setIsSubmitted(true);
    } catch (error: any) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-purple-950/20 to-black dark:from-black dark:via-purple-950/20 dark:to-black">
