...
API.interceptors.response.use(
  ...
  export const apiClient = {
    ...
    forgotPassword: async (data: ForgotPasswordRequest): Promise<ForgotPasswordResponse> => {
      try {
        const response = await API.post<ForgotPasswordResponse>(ApiRoutes.ForgotPassword, data)
        return response.data
      } catch (error) {
        throw error
      }
    ...
    resetPassword: async (data: ResetPasswordRequest): Promise<ResetPasswordResponse> => {
      try {
        const response = await API.post<ResetPasswordResponse>(ApiRoutes.ResetPassword, data)
        return response.data
      } catch (error) {
        throw error
      }
    ...
    verifyEmail: async (data: VerifyEmailRequest): Promise<VerifyEmailResponse> => {
      try {
        const response = await API.post<VerifyEmailResponse>(ApiRoutes.VerifyEmail, data)
        return response.data
      } catch (error) {
        throw error
      }
